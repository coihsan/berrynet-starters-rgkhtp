...
export default function Coverage(){
  ...
  return (
    <section className="max-w-screen-xl mx-auto py-[10rem]">
      <h1 className="text-3xl text-center pb-[2rem]">Find berrynet in your city</h1>
      ...
      <ul className='grid grid-cols-4 gap-5 mt-[2rem]'>
        {selectedData.map((SearchArea) => (
            <li className='p-[1rem] border border-blue-100/30 bg-zinc-400/10 rounded-xl' key={SearchArea.id}>
                <div className='flex flex-col border-b-1 pb-[1rem] border-blue-100/30'>
                    <h1 className='font-bold'>{SearchArea.village}</h1>
                    <span>{SearchArea.regency}</span>
                </div>
                <div className='flex flex-col gap-3 pt-[1rem] '>
                ...
                <div className='flex flex-col gap-2 w-full'>
                    ...
                    <p className='bg-slate-500 px-5 font-medium py-1 rounded-md flex gap-2'>
